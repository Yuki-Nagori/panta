...
重新设计并实现默认视口的立体 `panta` 欢迎图形。原方案不作为最终方案，本任务退回计划中；整体应用视觉和字形材质方向遵循 [081](081-qml-visual-language-and-iconography.md)，本任务只负责 VTK 立体几何与视口呈现，不再建立另一套应用颜色和图标规范。
...
1. 依据 081 冻结后的 Welcome 标志方向确定适合 VTK 的字形、轮廓、立体厚度与材质映射。
