...
| GoogleTest（仅测试） | v1.18.0（上游 commit `063de7e9578f82b369302001269680b4b1553359`） | 上游 `github.com/google/googletest`；仓库 Release `sdk-googletest-1.18.0` | 三平台归档 SHA256（2026-09-24 下载 sidecar 并与 Release API digest 对照，workflow run 35999015400）：macOS arm64 `654e87d943c68ab964da77ac3e9514900049e6f1b3c044e311017a7725cc2230`；Linux x86_64 `4b4b1281828c095cda29fdc4e7b150d816296da2b2c1375a2a2326ebc68de5ae`；Windows x86_64 `d070f6fbe77d1060033e8eb6bac97b7efba736db7b40fc50ef2ce9ce914c03ff` | 三平台自建静态 SDK（任务 070 workflow run 35999015400）；CMake `panta_require_sdk(googletest)` 仅在 `BUILD_TESTING=ON` 时下载/校验/解包到 `target/panta-deps/sdk/googletest/1.18.0/<triple>`，可由 Cargo 缓存目录共享 | 上游 CMake 安装；C++17、static、`BUILD_GMOCK=OFF`、Windows MSVC 2022 x64 Release `/MD` | `find_package(GTest CONFIG)`；`GTest::gtest` / `GTest::gtest_main` | BSD-3-Clause：归档内 `share/licenses/GoogleTest/LICENSE` | 019/070/071 |
