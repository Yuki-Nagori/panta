...
set(PANTA_NETGEN_INSTALL_DIR "${PANTA_SDK_OUT_ROOT}/netgen/${PANTA_NETGEN_VERSION}/${PANTA_SDK_TRIPLE}")

include(ExternalProject)
ExternalProject_Add(netgen_sdk
  ...
  COMMAND ${CMAKE_COMMAND} -E make_directory
          ${PANTA_NETGEN_INSTALL_DIR}/share/licenses/Netgen
...
file(WRITE "${CMAKE_BINARY_DIR}/netgen-panta-sdk.json.in"
[=[
{
  "name": "netgen",
...
ExternalProject_Add_Step(netgen_sdk metadata
  COMMAND ${CMAKE_COMMAND} -E copy_if_different
          ${CMAKE_BINARY_DIR}/netgen-panta-sdk-configure.json
